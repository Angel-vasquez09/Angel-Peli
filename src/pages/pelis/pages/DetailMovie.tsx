...
const DetailMovie = () => {
    ...
    const { data, isError, isLoading } = useQuery<IDetailMovie>([`detail-movie`,id],() => get(`movie/${id}`));
    ...
    return (
        <>
            ...
            <div className=" w-full h-full flex relative">
                ...
                <div className='md:pl-12 h-screen xs:w-full md:w-2/3 z-20 absolute md:top-0 md:left-0 p-3'>
