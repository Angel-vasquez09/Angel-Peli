    ...
    return (
        <div className={`p-1 scroll-section`} ref={sectionRef}>
            <div
                ...
                className={`${width} ${height} cursor-pointer rounded-md relative transition-all ease-in-out delay-150 hover:lg:w-[560px] border-transparent border-2 hover:border-white`}>
                <img
